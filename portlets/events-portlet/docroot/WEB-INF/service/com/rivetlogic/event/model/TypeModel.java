...
/**
 * The base model interface for the Type service. Represents a row in the &quot;rivetlogic_event_Type&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.rivetlogic.event.model.impl.TypeModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.rivetlogic.event.model.impl.TypeImpl}.
 * </p>
 *
 * @author juancarrillo
 * @see Type
...
public interface TypeModel extends BaseModel<Type> {
	...
	@Override
	public CacheModel<com.rivetlogic.event.model.Type> toCacheModel();
