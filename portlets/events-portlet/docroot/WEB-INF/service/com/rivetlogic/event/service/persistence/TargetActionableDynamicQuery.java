 ...
 * @generated
 */
public abstract class TargetActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public TargetActionableDynamicQuery() throws SystemException {
		setBaseLocalService(TargetLocalServiceUtil.getService());
		setClass(Target.class);

		setClassLoader(com.rivetlogic.event.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("targetId");
	}
}