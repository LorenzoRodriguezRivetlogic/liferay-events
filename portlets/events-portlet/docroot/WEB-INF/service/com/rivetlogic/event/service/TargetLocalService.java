...
/**
 * Provides the local service interface for Target. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author juancarrillo
 * @see TargetLocalServiceUtil
...
public interface TargetLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TargetLocalServiceUtil} to access the target local service. Add custom service methods to {@link com.rivetlogic.event.service.impl.TargetLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
