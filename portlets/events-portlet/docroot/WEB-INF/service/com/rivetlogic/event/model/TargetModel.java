...
/**
 * The base model interface for the Target service. Represents a row in the &quot;rivetlogic_event_Target&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.rivetlogic.event.model.impl.TargetModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.rivetlogic.event.model.impl.TargetImpl}.
 * </p>
 *
 * @author juancarrillo
 * @see Target
 ...
 * @generated
 */
public interface TargetModel extends BaseModel<Target> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a target model instance should use the {@link Target} interface instead.
	 */
	...
	@Override
	public CacheModel<com.rivetlogic.event.model.Target> toCacheModel();
