...
public class TypeUtil {
	...
	*/
	public static java.util.List<com.rivetlogic.event.model.Type> findByGroupId(
		long groupId)
	...
	* @throws com.rivetlogic.event.NoSuchTypeException if a matching type could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static com.rivetlogic.event.model.Type findByGroupId_First(
		long groupId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rivetlogic.event.NoSuchTypeException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rivetlogic.event.model.Type fetchByGroupId_First(
		long groupId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rivetlogic.event.model.Type findByGroupId_Last(
		long groupId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rivetlogic.event.NoSuchTypeException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rivetlogic.event.model.Type fetchByGroupId_Last(
		long groupId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws com.rivetlogic.event.NoSuchTypeException if a type with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static com.rivetlogic.event.model.Type[] findByGroupId_PrevAndNext(
	...
	* @param type the type
	*/
	public static void cacheResult(com.rivetlogic.event.model.Type type) {
	...
	*/
	public static void cacheResult(
		java.util.List<com.rivetlogic.event.model.Type> types) {
	...
	* @return the new type
	*/
	public static com.rivetlogic.event.model.Type create(long typeId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rivetlogic.event.model.Type remove(long typeId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rivetlogic.event.NoSuchTypeException {
		return getPersistence().remove(typeId);
	}

	public static com.rivetlogic.event.model.Type updateImpl(
		com.rivetlogic.event.model.Type type)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(type);
	}

	/**
	* Returns the type with the primary key or throws a {@link com.rivetlogic.event.NoSuchTypeException} if it could not be found.
	*
	* @param typeId the primary key of the type
	* @return the type
	* @throws com.rivetlogic.event.NoSuchTypeException if a type with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static com.rivetlogic.event.model.Type findByPrimaryKey(long typeId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rivetlogic.event.NoSuchTypeException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rivetlogic.event.model.Type fetchByPrimaryKey(long typeId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.rivetlogic.event.model.Type> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static TypePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (TypePersistence)PortletBeanLocatorUtil.locate(com.rivetlogic.event.service.ClpSerializer.getServletContextName(),
