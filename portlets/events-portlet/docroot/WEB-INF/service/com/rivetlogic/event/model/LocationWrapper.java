...
public class LocationWrapper implements Location, ModelWrapper<Location> {
	...
	*/
	...
	@Override
	public int compareTo(com.rivetlogic.event.model.Location location) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.rivetlogic.event.model.Location> toCacheModel() {
		return _location.toCacheModel();
	}

	@Override
	public com.rivetlogic.event.model.Location toEscapedModel() {
		return new LocationWrapper(_location.toEscapedModel());
	}

	@Override
	public com.rivetlogic.event.model.Location toUnescapedModel() {
