...
import com.rivetlogic.event.NoSuchLocationException;
import com.rivetlogic.event.model.Location;
import com.rivetlogic.event.model.impl.LocationImpl;
import com.rivetlogic.event.model.impl.LocationModelImpl;
...
public class LocationPersistenceImpl extends BasePersistenceImpl<Location>
	...
	@Override
	public Location updateImpl(com.rivetlogic.event.model.Location location)
		throws SystemException {
		location = toUnwrappedModel(location);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.rivetlogic.event.model.Location")));
